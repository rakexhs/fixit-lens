...
_Generated 2026-07-01T03:44:02.656078+00:00 by `backend/app/evals/run_evals.py` against 50 indexed manual chunks. All numbers below are computed live from the seeded manuals and eval datasets in `backend/data/eval/` - none are fabricated._
...
- MRR: 0.9594
- nDCG@5: 0.9693
- Avg retrieval latency: 0.74 ms
- P95 retrieval latency: 0.93 ms
...
- Avg diagnosis latency: 6.29 ms
- P95 diagnosis latency: 7.28 ms
